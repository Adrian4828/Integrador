...
import com.example.web.Services.DetalleService;
import com.example.web.Services.ProductoService;
import com.example.web.Services.VentasService;
...
public class VentasController {
    ...
    public String agregarVenta(Model model) {
        model.addAttribute("productos", productosService.obtenerProductos());
        return "agregarVenta";
    }
